...
export const BusinessOrdersManager: React.FC = () => {
  const { user } = useAuth();
  ...
  const fetchOrders = async () => {
    try {
      ...
      // جلب عناصر الطلبات للطلبات من القائمة
  ...
  const renderOrderItem = ({ item }: { item: Order }) => (
    ...
    >
      ...
      <Text style={styles.orderType}>
        {item.order_type === 'menu' ? 'طلب من القائمة' : 'طلب نصي'}
      </Text>
          ...
          <ScrollView style={styles.modalContent}>
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.infoText}>
                وقت التحضير المقدر: {selectedOrder.estimated_preparation_time} دقيقة
              </Text>
              <Text style={styles.infoText}>
