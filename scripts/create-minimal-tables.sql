-- ===================================================================
-- IGTaxi Minimal Setup - Safe Version
-- ===================================================================
...
-- Insert sample vehicle types (only if table is empty)
...
SELECT 'Tables created successfully! Vehicle types: ' || COUNT(*)::text as result 
